...
export default function ContactForm() {
  ...
  const [formData, setFormData] = useState({
    ...
    const handleSubmit = (e: React.FormEvent) => {
      ...
      window.location.href = `mailto:admisiones@valderramainternationalschool.com?subject=${encodeURIComponent(subjectText + ' - ' + formData.name)}&body=${encodeURIComponent(body)}`;
    };
