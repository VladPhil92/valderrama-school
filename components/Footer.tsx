      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 py-20">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 lg:gap-16">
          ...
          <div className="md:col-span-1">
            <Link 
              href={`/${locale}`} 
              className="inline-block mb-6 transition-opacity duration-300 hover:opacity-80"
            >
              ...
              {navItems.slice(0, 4).map((item) => (
                <li key={item.key}>
                  <Link
                    ...
                    className="text-sm text-slate-400 hover:text-white transition-all duration-300 font-light inline-block hover:translate-x-1"
                  >
                    {t(item.key)}
                  </Link>
                </li>
          ...
          <div className="md:col-span-1">
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3 group">
                <MapPin className="w-4 h-4 text-[#C41E3A] mt-0.5 flex-shrink-0 transition-transform duration-300 group-hover:scale-110" strokeWidth={1.5} />
              ...
              <li className="flex items-center gap-3 group">
                <Phone className="w-4 h-4 text-[#C41E3A] flex-shrink-0 transition-transform duration-300 group-hover:scale-110" strokeWidth={1.5} />
                <a 
                  href="tel:+573186428218" 
                  className="text-sm text-slate-400 hover:text-white transition-all duration-300 font-light"
                >
                  +57 318 642 8218
                </a>
              </li>
              <li className="flex items-center gap-3 group">
                <Mail className="w-4 h-4 text-[#C41E3A] flex-shrink-0 transition-transform duration-300 group-hover:scale-110" strokeWidth={1.5} />
                <a 
                  href="mailto:admisiones@valderramainternationalschool.com" 
                  className="text-sm text-slate-400 hover:text-white transition-all duration-300 font-light break-all"
                >
        ...
        <div className="flex justify-center gap-4 mt-16">
          {[
            ...
            <a
              ...
              className="w-10 h-10 rounded-full bg-slate-800 flex items-center justify-center hover:bg-[#C41E3A] transition-all duration-300 hover:scale-110"
              aria-label={social.label}
            >
              {social.icon === Facebook && <Facebook className="w-5 h-5 text-white" strokeWidth={1.5} />}
              {social.icon === Instagram && <Instagram className="w-5 h-5 text-white" strokeWidth={1.5} />}
              {social.icon === 'x' && (
