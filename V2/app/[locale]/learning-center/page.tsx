...
export default async function LearningCenterPage({
  ...
  const t = await getTranslations('LearningCenterPage');
    ...
    const services = [
      ...
      { key: 'support', icon: Users, color: '#0F766E' },
      { key: 'extracurricular', icon: Award, color: '#B45309' },
    ];
        ...
        <section className="py-24 bg-gray-50">
          <div className="container-custom max-w-3xl text-center">
            <div className="w-16 h-16 mx-auto mb-8 rounded-full flex items-center justify-center bg-[#C41E3A]/10">
              <GraduationCap className="w-8 h-8 text-[#C41E3A]" strokeWidth={1.5} />
            </div>
        ...
        <section className="py-24 bg-gray-50">
          <div className="container-custom max-w-3xl">
            <div className="text-center mb-12">
              <div className="w-14 h-14 mx-auto mb-6 rounded-full flex items-center justify-center bg-[#B45309]/10">
                <Clock className="w-7 h-7 text-[#B45309]" strokeWidth={1.5} />
              </div>
              ...
              <p className="text-gray-500 font-light">
                {t('schedule.description')}
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                          ...
                          <div className="bg-white p-6 text-center">
                            <h3 className="text-sm font-medium text-black uppercase tracking-wider mb-2">
                              {t('schedule.sunday.title')}
                            </h3>
                            <p className="text-gray-500 text-sm">{t('schedule.sunday.time')}</p>
                          </div>
                        </div>
          </div>
        </section>
