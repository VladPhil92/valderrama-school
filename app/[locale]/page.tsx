    ...
    <>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container-custom max-w-4xl text-center">
          <p className="text-xs uppercase tracking-[0.3em] text-gray-400 mb-6">{t('essence.label')}</p>
          <h2 className="text-xl md:text-2xl font-light mb-6 text-black leading-relaxed">
            {t('essence.title')}
          </h2>
        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="border border-gray-700 p-8 flex flex-col h-full hover:border-[#C41E3A] transition-colors">
              ...
              <Link href={`/${locale}/contact`} className="text-xs uppercase tracking-wider text-[#C41E3A] hover:text-white transition-colors mt-auto">
                {t('tutoring.cta')} →
              </Link>
            </div>
            <div className="border border-gray-700 p-8 flex flex-col h-full hover:border-[#C41E3A] transition-colors">
