...
export default async function CommunityPage({
  ...
  const t = await getTranslations('CommunityPage');
    ...
    const pillars = [
      { key: 'parents', icon: Users, color: '#0F766E' },
      { key: 'service', icon: Heart, color: '#C41E3A' },
      { key: 'partnerships', icon: Handshake, color: '#1F2A44' },
      { key: 'events', icon: Calendar, color: '#B45309' },
    ];
          ...
          <div className="container-custom">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
              <div className="relative h-80 bg-gray-200">
                <Image
                  src="/images/facilities/Recepcion.webp"
                  alt="Community"
                  fill
